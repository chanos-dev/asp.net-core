#pragma checksum "C:\Users\Chanos\Desktop\git\csharp\asp.net\MyWeb\MyWeb.HomeWeb\Views\Home\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0574fd0194a72a95ce81a54d4d493c7dcd382909"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0574fd0194a72a95ce81a54d4d493c7dcd382909", @"/Views/Home/Chat.cshtml")]
        ...
        <div class=""col-md-12"">
                ...
                <div class=""row no-gutters"">
                    <div class=""col-lg-3 col-xl-2 border-right"">
                        <div class=""card-body border-bottom"">
                            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0574fd0194a72a95ce81a54d4d493c7dcd3829093565", async() => {
                                    ...
                                    <div class=""message-center"">
                                        ...
                                        <a href=""javascript:void(0)""
                                           class=""message-item d-flex align-items-center border-bottom px-3 py-2"">
                                            ...
                                            <div class");
            WriteLiteral(@"=""w-75 d-inline-block v-middle pl-2"">
                                           ...
                                           class=""message-item d-flex align-items-center border-bottom px-3 py-2"">
                                            <div class=""user-img"">
                                                <img src=""../assets/images/users/3.jpg""
                                                     alt=""user"" class=""img-fluid rounded-circle""
                                                     width=""40px""> <span class=""profile");
            WriteLiteral(@"-status away float-right""></span>
                                            </div>
                                            <div class=""w-75 d-inline-block v-middle pl-2"">
                                           ...
                                           class=""message-item d-flex align-items-center border-bottom px-3 py-2"">
                                            <div class=""user-img"">
                                                <img src=""../assets/images/users/5.jpg""
                                                     alt=""user"" class=""img-fluid rounded-circle""
                                                     width=""40px"">");
            WriteLiteral(@" <span class=""profile-status offline float-right""></span></span>
                                            </div>
                                            <div class=""w-75 d-inline-block v-middle pl-2"">
            ...
            WriteLiteral(@"             see the my admin!
                                        ...
                                        <a href=""javascript:void(0)""
                                           class=""message-item d-flex align-items-center border-bottom px-3 py-2"">
                                            <div class=""user-img"">
                                                <img src=""../assets/images/users/7.jpg""
                                                     alt=""user"" class=""img-fluid rounded-circle""
                                                     width=""40px""> <span class");
            WriteLiteral(@"=""profile-status offline float-right""></span>
                                            </div>
                                            <div class=""w-75 d-inline-block v-middle pl-2"">
                                                <h6 class=""message-title mb-0 mt-1"">Pavan kumar</h6>
                                                <span class=""font-12 text-nowrap d-block text-muted text-truncate"">
            ...
            WriteLiteral(@"                            <a href=""javascript:void(0)""
                                           class=""message-item d-flex align-items-center px-3 py-2"">
                                            <div class=""user-img"">
                                                <img src=""../assets/images/users/8.jpg""
                                                     alt=""user"" class=""img-fluid rounded-circle""
                                                     width=""40px""> <span class=""profile-status offline float-right""></span>
                                            </div>
                                            <div class=""w-75 d-inline-block v-middle pl-2"">
  ...
  ");
                    ...
                    <div class=""col-lg-9  col-xl-10"">
                        <div class=""chat-box scrollable position-relative""
                            ...
                            <ul class=""chat-list list-style-none px-3 pt-3"">
                                <!--chat Row -->
                                <li class=""chat-item list-style-");
            WriteLiteral(@"none mt-3"">
        ...
        ");
            WriteLiteral(@"                            <div class=""chat-time d-block font-10 mt-1 mr-0 mb-3"">
                                        10:57 am
                                    </div>
                                </li>
                                <!--chat Row -->
                                ...
                                <li class=""chat-item odd list-style-none mt-3"">
                                    <");
            WriteLiteral(@"div class=""chat-content text-right d-inline-block pl-3"">
            ...
            WriteLiteral(@"                 </div>
                                ...
                                <li class=""chat-item odd list-style-none mt-3"">
                                    <div class=""chat-content text-right d-inline-block pl-3"">
                                    ");
            WriteLiteral(@"    <div class=""box msg p-2 d-inline-block mb-1"">
                                            I
                                            would love to
                                            join the team.
                                        </div>
                                ...
                                <li class=""chat-item odd list-style-none mt-3"">
                                    ...
                                    <div class=""chat-time text-right ");
            WriteLiteral(@"d-block font-10 mt-1 mr-0 mb-3"">
                                        10:59 am
                                    </div>
                                </li>
                            </ul>
