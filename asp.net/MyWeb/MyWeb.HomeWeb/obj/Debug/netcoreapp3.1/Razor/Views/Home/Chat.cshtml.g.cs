#pragma checksum "C:\Users\Chanos\Desktop\git\asp.net\asp.net\MyWeb\MyWeb.HomeWeb\Views\Home\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3c94273bbce9f6657f64a7a1b8ecfb8900454dcd"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3c94273bbce9f6657f64a7a1b8ecfb8900454dcd", @"/Views/Home/Chat.cshtml")]
        ...
        <div class=""col-md-12"">
                ...
                <div class=""row no-gutters"">
                    <div class=""col-lg-3 col-xl-2 border-right"">
                        <div class=""card-body border-bottom"">
                            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3c94273bbce9f6657f64a7a1b8ecfb8900454dcd3568", async() => {
                                           ...
                                           class=""message-item d-flex align-items-center border-bottom px-3 py-2"">
                                            <div class=""user-img"">
                                                <img src=""/lib/adminmart-lite/assets/images/users/3.jpg""
                                                     alt=""user"" class=""img-fluid rounded-circle""
                                    ");
            WriteLiteral(@"                 width=""40px""> <span class=""profile-status away float-right""></span>
                                            </div>
                                            <div class=""w-75 d-inline-block v-middle pl-2"">
            ...
            WriteLiteral(@"                                    Just
                                        ...
                                        <a href=""javascript:void(0)""
                                           class=""message-item d-flex align-items-center border-bottom px-3 py-2"">
                                            <div class=""user-img"">
                                                <img src=""/lib/adminmart-lite/assets/images/users/5.jpg""
                                                     alt=""user"" class=""img-flu");
            WriteLiteral(@"id rounded-circle""
          ...
          ");
                                        ...
                                        <a href=""javascript:void(0)""
                                           class=""message-item d-flex align-items-center border-bottom px-3 py-2"">
                                            ...
                                            <div class=""w-75 d-inline-block v-middle pl-2"">
                                                ...
                                                <span class=""font-12 text-nowrap d-block text-muted text-trunc");
            WriteLiteral(@"ate"">
                                                    Just
                                                    see the my admin!
                                                </span>
                                        ...
                                        <a href=""javascript:void(0)""
                                           class=""message-item d-flex align-items-center border-bottom px-3 py-2"">
                                            <div class=""user-img"">
                                                <img src=""/lib/adminmart-lite/assets/images/users/7.jpg""
                                                     alt");
            WriteLiteral(@"=""user"" class=""img-fluid rounded-circle""
                                                     width=""40px""> <span class=""profile-status offline float-right""></span>
                                            </div>
                                            <div class=""w-75 d-inline-block v-middle pl-2"">
                                                <h6 class=""message-title mb-0 mt-1"">Pavan kumar</h6>
                                        ...
                                        <a href=""javascript:void(0)""
                                           class=""message-item d-flex align-items-center px-3 py-2"">
                                            ...
                                            <div class=""w-75 d-inline-block v-middle pl-2"">
                                                ...
                                                <span class=""font-12 text-nowrap d-block text-muted text-trun");
            WriteLiteral(@"cate"">
                                                    Just
                                                    see the my admin!
                                                </span>
                    ...
                    <div class=""col-lg-9  col-xl-10"">
                        <div class=""chat-box scrollable position-relative""
                            ...
                            <!--chat Row -->
                            <ul class=""chat-list list-");
            WriteLiteral(@"style-none px-3 pt-3"">
                                <!--chat Row -->
                                ...
                                <li class=""chat-item list-style-none mt-3"">
                                    ...
                                    <div class=""chat-content d-inline-block pl-3"">
                                        ...
                                        <div class=""msg p-2 d-inline-block mb-1"">
                                            It’s
                                           ");
            WriteLiteral(@" Great opportunity to
                                            work.
                                        </div>
                                    </div>
                                    <div class=""chat-time d-block font-10 mt-1 mr-0 mb-3"">
            ...
            WriteLiteral(@"li>
                                ...
                                <li class=""chat-item list-style-none mt-3"">
                                    <div class=""chat-img d-inline-block"">
                    ");
            WriteLiteral(@"                    <img src=""/lib/adminmart-lite/assets/images/users/3.jpg"" alt=""user""
                                             class=""rounded-circle"" width=""45"">
                                    </div>
                                    <div class=""chat-content d-inline-block pl-3"">
                                ...
                                <!--chat Row -->
                       ");
            WriteLiteral(@"         <li class=""chat-item odd list-style-none mt-3"">
                                    <div class=""chat-content text-right d-inline-block pl-3"">
                                        <div class=""box msg p-2 d-inline-block mb-1"">
                                            I
                                            would love to
            ...
            WriteLiteral(@"                       </div>
                        ...
                        <div class=""card-body border-top"">
                            <div class=""row"">
                                ...
                                <div class=""col-3"">
                                    <a class=""btn-circle btn-lg b");
            WriteLiteral(@"tn-cyan float-right text-white""
